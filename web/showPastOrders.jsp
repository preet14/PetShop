<%-- 
    Document   : showPastOrders
    Created on : Apr 14, 2019, 2:37:23 PM
    Author     : user
--%>
...
<head>
	...
	<title>Pet Shop | Past Orders</title>
                    ...
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <table class="table table-striped">
                                <%
                                    try{
                                   ArrayList<OrdersTable> ol = (ArrayList<OrdersTable>)session.getAttribute("orderdeliver");
                            ...
                            <tbody>
                              ...
                              <tr style="color:black;">
                                ...
                                <%
                                    if(ol.get(i).getPermission().equals("delivered")){
                                %>
                                <td>Delivered</td>
                                <%
                                    }else{
