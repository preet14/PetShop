<%-- 
    Document   : cartResults
    Created on : Apr 12, 2019, 2:28:47 PM
    Author     : user
--%>
<%
...
<head>
	...
	<title>Pet Shop | Items In Cart</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title" style="color:black;font-weight: bold;"><%= pl.get(i).getBreed() %></h4>
                                <p class="category" style="color:black;font-weight: bold;"><%= pl.get(i).getAge() %></p>
                                <p class="category" style="color:black;font-weight: bold;"><%= pl.get(i).getGender() %></p>
                            </div>
                            <div class="content">
                                <%
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        <h5 style="color:black;font-weight: bold;"><%= pl.get(i).getPrice() %></h5>
                                    </div>
                                    <hr>
                                    <div class="stats">
                                        <a href="deleteToCart?breed=<%= pl.get(i).getBreed() %>&usname=<%= (String) session.getAttribute("uname") %>&cartt=<%= count %>&ages=<%= pl.get(i).getAge() %>"><center><button class="btn" style="background-color:red;">Delete</button></center></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                %>
                                <p class="category" style="color:black;font-weight: bold;">Net Total : <%= sum %></p>
                            </div>
                            <div class="content">
                                
                                <div class="footer">
                                    <div class="legend">
                                        <h5 style="color:black;font-weight: bold;"></h5>
                                    </div>
                                    <hr>
                                    <div class="stats">
                                        <a href="orderForm1.jsp"><center><button class="btn" style="background-color:orange;">Proceed to buy</button></center></a>
                                    </div>
                                </div>
                            </div>
                        </div>
