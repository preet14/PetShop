        ...
        <div class="content" >
            <div class="container-fluid">
                <div class="row">
                    ...
                    <%
                        ArrayList<Pet> pl = (ArrayList<Pet>)session.getAttribute("petsInfo");
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    ...
                                    <hr>
                                    <div class="stats">
                                        <a href="addToCart?breed=<%= pl.get(i).getBreed() %>&usname=<%= (String) session.getAttribute("uname") %>&price=<%= pl.get(i).getPrice() %>&gen=<%= pl.get(i).getGender() %>&cartt=<%= count %>&ages=<%= pl.get(i).getAge() %>"><center><button class="btn">Add To Cart</button></center></a>
                                    </div>
                                </div>
                            </div>
                        </div>
